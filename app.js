...
const getWeatherData = async () => {
  const weatherUrl = `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=a27c1ffd5f19d29f79dffb9212d4a2fb`;
  ...
  try {
    ...
    w_pressure.innerHTML = `${wind.speed} m/s`;
    w_feelsLike.innerHTML = `${main.pressure} hPa`;
  } catch (error) {
    console.log(error);
  }
};
